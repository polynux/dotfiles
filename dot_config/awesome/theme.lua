...
-- theme.taglist_spacing_widget = {
--     color  = "#dddddd",
--     shape  = gears.shape.powerline,
--     widget = wibox.widget.separator,
-- }

theme.taglist_font = "Caskaydia Cove NF 18"
...
theme.menu_icon = gfs.get_configuration_dir() .. "assets/arch.png"
...
theme.wallpaper = "/home/polynux/Images/awesome.png"
