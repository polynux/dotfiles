...
local mylauncher = awful.widget.launcher({ image = beautiful.menu_icon,
    menu = mymainmenu })
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86MonBrightnessUp", function() awful.spawn("xbacklight -inc 5") end,
        {}),
    awful.key({}, "XF86AudioLowerVolume", function() awful.spawn("amixer -D pulse set Master 5%-") end,
        {}),
    awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn("amixer -D pulse set Master 5%+") end,
        {}),
    ...
    ruled.client.append_rule {
        ...
        rule_any   = {
            ...
            class    = {
                ...
                "Tor Browser", "Wpa_gui", "veromix", "xtightvncviewer", "Variety"
            },
