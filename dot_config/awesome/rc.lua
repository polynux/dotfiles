...
local mylauncher = awful.widget.launcher({ image = beautiful.menu_icon, menu = mymainmenu })
...
kbdcfg.add_primary_layout("English", "us", "us_intl")
...
local styleWidget = function(widget, color)
    return wibox.container.background(wibox.container.margin(widget, 3, 3, 0, 0), color, gears.shape.rounded_rect)
end
...
awful.keyboard.append_global_keybindings({
    awful.key({ modkey }, "F11", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule({
        id = "floating",
        rule_any = {
            instance = { "copyq", "pinentry", "pavucontrol", "variety" },
            class = {
                "Arandr",
                "Blueman-manager",
                "Gpick",
